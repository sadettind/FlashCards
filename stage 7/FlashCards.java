...
public class FlashCards {
    ...
    public FlashCards(String[] arr) {
        this.args = Arrays.asList(arr);

        if (args.contains("-import")) {
            importCard(args.get(args.indexOf("-import") + 1));
        }
    }
    ...
    private void exit() {
        if (args.contains("-export")) {
            exportCard(args.get(args.indexOf("-export") + 1));
        }
        print("Bye bye!");
    }
    ...
    public void exportCard(String s) {
        print("File name:");
        String fileName = null;
        if (s == null) {
            fileName = scanner.nextLine();
